...
do
    python ./src/extract_synchronized_video_and_game_state.py \
        -p $dataset_path/participant_${i} \
        -o $dataset_path/participant_${i}/frames;

    python ./src/extract_synchronized_bvp_amplitude.py \
        -p $dataset_path/participant_${i};

    python ./src/average_bvp_by_second.py \
        -p $dataset_path/participant_${i};

    python ./src/calculate_mean_response.py \
        -i $dataset_path/participant_${i}/participant_${i}_sensor/BVP_AMP_AVG.csv \
